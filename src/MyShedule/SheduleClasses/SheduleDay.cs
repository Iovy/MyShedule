...
namespace MyShedule.ScheduleClasses
{
    ...
    public class ScheduleDay
    {
        ...
        public ScheduleDay()
        {
            //times
            Week = Week.Another;
            Day = ScheduleClasses.Day.Another; 
            //main
        ...
        public List<ScheduleLesson> Lessons;
        ...
        private IEnumerable<ScheduleLesson> InitializeLessonsOfDay(IEnumerable<ScheduleRoom> Rooms, int CountHoursCreating, int FirstLssn)
        {
            ...
            foreach (ScheduleRoom room in Rooms)
                for (int counterHour = FirstLssn; counterHour <= CountHoursCreating + FirstLssn - 1; counterHour++)
                    yield return new ScheduleLesson(new ScheduleTime(Week, Day, counterHour), room.Name, GetDatesLesson());
        }
        ...
        public IEnumerable<ScheduleLesson> NonEmptyLessons { get { return Lessons.Where(x => !x.IsEmpty); } }
