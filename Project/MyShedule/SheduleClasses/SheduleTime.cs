...
namespace ScheduleClasses
{
    ...
    public class ScheduleTime
    {
        ...
        public ScheduleTime(Week week, Day day, int hour)
        {
            Week = week;
            Day = day;
            Hour = hour;
        ...
        public ScheduleTime Copy()
        {
            return new ScheduleTime(Week, Day, Hour);
        }

        public override bool Equals(object obj) 
        {
            if (!(obj is ScheduleTime))                
                return false;
            return Equals((ScheduleTime)obj); 
        }
        ...
        public static bool operator ==(ScheduleTime time1, ScheduleTime time2)
        {
